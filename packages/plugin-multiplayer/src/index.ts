...
export async function createMultiplayerPlugin(input: PluginInput) {
  ...
  await logger.log("debug", "plugin loaded", { handle, port: envPort, host: envHost, role: plugin.roleState.kind })
  ...
  return {
    ...
    tool: {
      mp_host: tool({
        ...
        args: {},
        async execute() { return plugin.mpHost() },
      }),
      ...
      mp_join: tool({
        ...
        async execute(args) { return plugin.mpJoin(args.code) },
      }),
      ...
      mp_leave: tool({
        ...
        args: {},
        async execute() { return plugin.mpLeave() },
      }),
      ...
      mp_cancel_leave: tool({
        ...
        args: {},
        async execute() { return plugin.mpCancelLeave() },
      }),
      ...
      mp_volunteer: tool({
        ...
        args: {},
        async execute() { return plugin.mpVolunteer() },
      }),
      ...
      mp_code: tool({
        ...
        args: {},
        async execute() { return plugin.mpCode() },
      }),
      ...
      mp_status: tool({
        ...
        args: {},
        async execute() { return plugin.mpStatus() },
      }),
      ...
      mp_rejoin: tool({
        ...
        async execute(args) { return plugin.mpRejoin(args.code) },
      }),
    },
  }
}
